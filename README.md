## robot_upstart (jazzy) - 1.0.4-1

The packages in the `robot_upstart` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy robot_upstart --override-release-repository-push-url git@github.com:revyos-ros/robot_upstart-release.git` on `Thu, 19 Dec 2024 06:54:24 -0000`
...
- release repository: https://github.com/revyos-ros/robot_upstart-release.git
...
## robot_upstart (humble) - 1.0.4-1

The packages in the `robot_upstart` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble robot_upstart --override-release-repository-push-url git@github.com:revyos-ros/robot_upstart-release.git` on `Mon, 23 Sep 2024 05:20:10 -0000`
...
## robot_upstart (galactic) - 1.0.2-1

The packages in the `robot_upstart` repository were released into the `galactic` distro by running `/usr/bin/bloom-release robot_upstart -t galactic -r galactic` on `Thu, 21 Apr 2022 22:17:02 -0000`
...
## robot_upstart (foxy) - 1.0.2-1

The packages in the `robot_upstart` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy -t foxy robot_upstart` on `Thu, 21 Apr 2022 22:09:32 -0000`
...
## robot_upstart (galactic) - 1.0.1-1

The packages in the `robot_upstart` repository were released into the `galactic` distro by running `/usr/bin/bloom-release robot_upstart -r galactic -t galactic` on `Tue, 12 Apr 2022 15:56:58 -0000`
...
## robot_upstart (foxy) - 1.0.1-1

The packages in the `robot_upstart` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy -t foxy robot_upstart` on `Thu, 07 Apr 2022 16:50:20 -0000`
...
## robot_upstart (foxy) - 1.0.0-3

The packages in the `robot_upstart` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy -t foxy robot_upstart` on `Thu, 07 Apr 2022 16:36:44 -0000`
...
## robot_upstart (foxy) - 1.0.0-2

The packages in the `robot_upstart` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy -t foxy robot_upstart` on `Wed, 16 Feb 2022 15:31:58 -0000`
...
## robot_upstart (foxy) - 1.0.0-1

The packages in the `robot_upstart` repository were released into the `foxy` distro by running `/usr/bin/bloom-release -r foxy -t foxy robot_upstart` on `Wed, 16 Feb 2022 15:25:49 -0000`
...
## robot_upstart (melodic) - 0.3.3-1

The packages in the `robot_upstart` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic robot_upstart` on `Wed, 12 May 2021 16:45:07 -0000`
...
## robot_upstart (noetic) - 0.4.0-1

The packages in the `robot_upstart` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic robot_upstart` on `Mon, 01 Mar 2021 22:06:42 -0000`
...
## robot_upstart (melodic) - 0.3.0-0

The packages in the `robot_upstart` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic robot_upstart` on `Wed, 23 May 2018 20:18:47 -0000`
...
## robot_upstart (kinetic) - 0.3.0-0

The packages in the `robot_upstart` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic robot_upstart --edit-track` on `Wed, 23 May 2018 20:08:48 -0000`
...
## robot_upstart (jade) - 0.2.2-0

The packages in the `robot_upstart` repository were released into the `jade` distro by running `/usr/local/bin/bloom-release -r jade -t jade robot_upstart` on `Tue, 24 Jan 2017 03:30:24 -0000`
...
## robot_upstart (kinetic) - 0.2.1-0

The packages in the `robot_upstart` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release -r kinetic -t kinetic robot_upstart` on `Tue, 20 Dec 2016 03:06:19 -0000`
...
## robot_upstart (jade) - 0.2.0-0

The packages in the `robot_upstart` repository were released into the `jade` distro by running `/usr/local/bin/bloom-release -r jade -t jade robot_upstart --new-track` on `Sat, 14 Mar 2015 21:10:25 -0000`
...
## robot_upstart (indigo) - 0.1.2-0

The packages in the `robot_upstart` repository were released into the `indigo` distro by running `/usr/local/bin/bloom-release -r indigo -t indigo robot_upstart` on `Fri, 13 Mar 2015 21:51:17 -0000`
...
## robot_upstart (hydro) - 0.0.7-0

The packages in the `robot_upstart` repository were released into the `hydro` distro by running `/usr/local/bin/bloom-release -r hydro -t hydro robot_upstart` on `Fri, 13 Mar 2015 21:48:39 -0000`
